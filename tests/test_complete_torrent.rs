...
async fn test_download_torrent_from_magnet_link() {
    ...
    let magnet_link = "magnet:?xt=urn:btih:faa73597e79968e1946fcb223e274aa5bb7d2eda&x.pe=127.0.0.1:50100&dn=screenshots";
    ...
    with_timeout!(launch_peers::<Seeder>(
        ...
        data_dir,
        ConnectionMode::Incoming {
            listen_addrs: vec![SocketAddrV4::new(Ipv4Addr::LOCALHOST, 50100).into()]
        },
        true
    ));
